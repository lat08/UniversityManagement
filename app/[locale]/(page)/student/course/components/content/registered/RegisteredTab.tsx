...
export function RegisteredCourses({ 
  ...
  const tableColumns = useMemo(() => [
    ...
    { key: 'date', label: t('columns.enrollmentDate'), align: 'center' as const },
    { key: 'status', label: t('columns.status'), align: 'center' as const },
    { key: 'action', label: t('columns.action'), align: 'center' as const },
  ], [t])
        ...
        <td className="px-6 py-4">
          <div className="flex justify-center">
            <input
              ...
              title={isLocked ? t('lockedTooltip') : ''}
            />
          </div>
        </td>
