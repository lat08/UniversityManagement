  ...
  return (
    <Card className="shadow-sm h-full flex flex-col">
      <CardHeader className="pb-3 flex-shrink-0">
        <CardTitle className="text-sm lg:text-base font-semibold">{t('upcomingEvents')}</CardTitle>
      </CardHeader>
      ...
      <CardContent className="space-y-3 flex-1 relative max-h-[400px] overflow-y-auto">
        {isLoading ? (
          ...
          <div className="text-center py-8 text-[var(--text-secondary)] text-sm">{t('noEvents')}</div>
        )}
      </CardContent>
    </Card>
  );
