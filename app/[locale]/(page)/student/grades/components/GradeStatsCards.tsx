  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
      <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 relative overflow-hidden">
        ...
        <p className="text-xs sm:text-sm text-gray-600 mb-2 font-medium relative z-10">{t('gpa')}</p>
        <p className="text-3xl sm:text-4xl font-bold text-gray-900 mb-1 relative z-10">{gpaDisplay}</p>
        <p className="text-xs sm:text-sm text-gray-600 relative z-10">{t('gpaScale')}</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 relative overflow-hidden">
        ...
        <p className="text-xs sm:text-sm text-gray-600 relative z-10">/{totalRequiredCredits} {t('credits')}</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 relative overflow-hidden">
        ...
        <p className="text-xs sm:text-sm text-gray-600 relative z-10">{t('courses')}</p>
      </div>
    </div>
  );
};
