...
export default function PaymentHistoryTab({ payments }: PaymentHistoryTabProps) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-base lg:text-lg font-bold text-gray-900">{t('historySection.title')}</h2>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-stretch justify-between">
        ...
        <div className="flex gap-3 sm:flex-initial">
          ...
          >
            ...
            <span className="text-xs lg:text-sm font-medium">{t('historyActions.exportButton')}</span>
          </button>
        </div>
      </div>
