  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex justify-end">
          <div className="space-y-2 min-w-[250px]">
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">{t('paymentSummary.selectedCredits')}</span>
              <span className="font-semibold text-gray-800">{totalCredits}</span>
            </div>
            <div className="border-t border-gray-300"></div>
            <div className="flex justify-between items-center">
              <span className="text-base font-semibold text-gray-900">{t('paymentSummary.total')}</span>
      ...
      >
        ...
        <span>{t('paymentSummary.payButton')}</span>
      </button>
    </div>
  );
}
