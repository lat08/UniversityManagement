...
user_role: Student
screens_and_ui_flow:
- Primary route: `app/[locale]/(page)/student/regulations/page.tsx` orchestrates data fetch, filters, and action triggers.
...
- Pull copy from `next-intl` namespaces (e.g., `student.regulations`) and keep translation keys synchronized across components and modals.
