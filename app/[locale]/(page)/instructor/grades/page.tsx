...
const InstructorGradesPage = () => {
  ...
  return (
    <div key="instructor-grades-content" className="animate-in fade-in duration-200 min-h-screen bg-gray-50">
      <div className="flex flex-col gap-6">
          ...
          <>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {t('header.courseCode')}: {gradesInfo.courseCode} | {t('header.semester')}: {selectedCourseClass.semesterName}
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <span className="text-sm font-medium">
                        {selectedCourseClass?.isDraftEditable ? t('header.editable') : t('header.locked')}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            {gradesInfo && currentDataMatches && (
              <>
                ...
                {showHistory && (
                  <Suspense fallback={<div className="bg-white rounded-lg shadow-sm p-8 text-center">{t('history.loading')}</div>}>
                    <div className="mt-6">
        ...
        {!selectedCourseClassId && (
            ...
            <p className="text-gray-600">{t('empty.selectCourseClass')}</p>
          </div>
        )}
      </div>
    </div>
