...
screens_and_ui_flow:
- Primary route: `app/[locale]/(page)/instructor/regulations/page.tsx` orchestrates data fetch, filters, and action triggers.
...
- Pull copy from `next-intl` namespaces (e.g., `instructor.regulations`) and keep translation keys synchronized across components and modals.
