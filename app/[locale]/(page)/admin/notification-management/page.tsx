...
export default function NotificationManagementPage() {
  ...
  const [resizableColumns, setResizableColumns] = useState<ResizableColumn[]>([
    ...
    { key: 'title', label: t('columns.title'), width: 250, minWidth: 200, align: 'left', visible: true, required: true },
    { key: 'notificationType', label: t('columns.type'), width: 120, minWidth: 100, align: 'center', visible: true },
    { key: 'targetType', label: t('columns.target'), width: 180, minWidth: 150, align: 'left', visible: true },
    { key: 'sendingMethod', label: t('columns.method'), width: 140, minWidth: 120, align: 'center', visible: true },
    { key: 'totalRecipients', label: t('columns.recipients'), width: 120, minWidth: 100, align: 'center', visible: true },
    { key: 'status', label: t('columns.status'), width: 140, minWidth: 120, align: 'center', visible: true },
    { key: 'scheduledDate', label: t('columns.scheduledDate'), width: 180, minWidth: 150, align: 'left', visible: true },
    { key: 'createdAt', label: t('columns.createdAt'), width: 180, minWidth: 150, align: 'left', visible: true },
    { key: 'actions', label: tCommon('actions'), width: 140, minWidth: 100, align: 'center', visible: true, required: true },
  ]);
            ...
            <div className="flex items-center justify-between p-3 bg-[#E8F4FF] border border-[#0053AD]/20 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-[#0053AD]">
                  {t('selected', { count: selectedNotificationIds.size })}
                </span>
              </div>
                    ...
                    <div>
                      ...
                      {loadingAdvancedData ? (
                        ...
                        <DropdownSearch
                          ...
                          searchPlaceholder={t('searchInstructor')}
                          onChange={(value) => {
