    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: Building2, labelKey: "menu.divisionManagement", href: "/admin/division-management" },
          { icon: GraduationCap, labelKey: "menu.facultyManagement", href: "/admin/faculty-management" },
          { icon: GraduationCap, labelKey: "menu.departmentManagement", href: "/admin/department-management" },
      ...
      },
      {
        ...
        items: [
          ...
          { icon: Bell, labelKey: "menu.scheduleChanges", href: "/admin/schedule-change-management" },
        ],
      },
      {
