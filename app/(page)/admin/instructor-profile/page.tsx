...
export default function InstructorProfilePage() {
  ...
  const handleDeleteInstructor = async (instructor: InstructorListItem) => {
    ...
    const confirmed = window.confirm('Bạn có chắc chắn muốn xóa giảng viên này? Hành động này không thể hoàn tác.');
    if (!confirmed) return;
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <div>
        <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Hồ sơ Giảng viên</h1>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-4 lg:p-6 border-b border-gray-200 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h2 className="text-lg lg:text-xl font-semibold text-gray-900">Danh sách giảng viên</h2>
              <p className="text-xs lg:text-sm text-gray-600 mt-1">
                Quản lý hồ sơ và thông tin giảng viên
              </p>
            </div>
                ...
                <table className="min-w-full text-sm">
                  <thead>
                    <tr className="bg-[#0053AD] text-white">
                      ...
                      <th className="py-3 px-4 text-left">Khoa/Bộ môn</th>
                      <th className="py-3 px-4 text-left">Chuyên môn</th>
                      <th className="py-3 px-4 text-left">Liên hệ</th>
                      <th className="py-3 px-4 text-center">Số lớp</th>
                      <th className="py-3 px-4 text-center">Trạng thái</th>
                      <th className="py-3 px-4 text-center w-32">HĐ</th>
                    </tr>
                  </thead>
                  <tbody>
