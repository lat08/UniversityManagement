...
export const GradeVersionModal = ({
  ...
  const columns: TableColumn[] = [
    ...
    { key: 'attendanceGrade', label: `CC (${GRADE_WEIGHTS.ATTENDANCE * 100}%)`, align: 'center' },
    { key: 'midtermGrade', label: `GK (${GRADE_WEIGHTS.MIDTERM * 100}%)`, align: 'center' },
    { key: 'finalGrade', label: `CK (${GRADE_WEIGHTS.FINAL * 100}%)`, align: 'center' },
    { key: 'average', label: 'TB', align: 'center' },
  ];
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            {versionDetail && (
              ...
              >
                {GRADE_STATUS_LABELS[versionDetail.versionStatus] || versionDetail.versionStatus}
              </span>
            )}
          </div>
          <button
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Lớp học phần</p>
                    <p className="font-medium text-gray-900">{versionDetail.className}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Phiên bản</p>
                    <p className="font-medium text-gray-900">Version {versionDetail.versionNumber}</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  {versionDetail.submittedBy && (
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-sm text-gray-600">Người gửi duyệt</p>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-sm text-gray-600">
                          {versionDetail.versionStatus === 'Approved' ? 'Người duyệt' : 'Người từ chối'}
                        </p>
              ...
              {versionDetail.submissionNote && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-sm font-medium text-blue-900 mb-1">Ghi chú gửi duyệt</p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">
                  Danh sách điểm ({versionDetail.totalStudents} sinh viên)
                </h3>
