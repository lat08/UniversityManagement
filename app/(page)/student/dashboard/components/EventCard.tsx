      ...
      <CardContent className="space-y-3 flex-1 relative max-h-[400px] overflow-y-auto">
        {upcomingEvents.length > 0 ? (
          <div className="relative pl-6">
            ...
            <div className="absolute left-2 top-1 bottom-0 w-[1.5px] bg-gray-400" />
            ...
            {upcomingEvents.map((event, index) => (
              ...
              >
                {/* Blue dot */}
                <div className="absolute -left-[23px] w-4 h-4 top-1 rounded-full border-4 border-blue-800/90 bg-white z-10" />

                {/* Event card */}
                <div className="border border-blue-600 flex-1 p-3 rounded-sm  hover:bg-[var(--bg-tertiary)] transition-colors">
                  <h4 className="text-sm lg:text-base font-bold text-blue-800/90 mb-1">
                    {event.title}
                  </h4>
