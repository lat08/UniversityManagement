  ...
  return (
    <Card className="shadow-sm h-full">
      <CardHeader className="pb-4">
        <CardTitle className="text-base font-bold text-[var(--text-primary)] text-left">Thống kê học tập</CardTitle>
        ...
        {isLoading ? (
          ...
          <>
            <div className="space-y-2">
              <div className="text-sm text-[var(--text-secondary)] text-center">Điểm trung bình tích lũy</div>
            ...
            <div className="space-y-4">
              <div className="text-sm text-[var(--text-secondary)] text-center">Tín chỉ tích lũy</div>
            ...
            <div className="space-y-3">
              <div className="text-sm text-[var(--text-secondary)] text-center">Xếp loại</div>
              <div className="text-center">
