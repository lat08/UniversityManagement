...
export default function ScoresPage() {
  ...
  // Dữ liệu điểm số theo học kỳ - Điểm cao gấp đôi
  const semesterData = [
    {
      id: "hk1-2023-2024",
      semester: "HK1 2023 - 2024",
      courses: [
        { code: "2BUS21440", name: "XÁC SUẤT VÀ THỐNG KÊ", credits: 3, score10: 9.2, status: "Đạt" },
        { code: "2ENG1317", name: "SPEAKING 1", credits: 1, score10: 9.4, status: "Đạt" },
        { code: "2ENG1318", name: "LISTENING 1", credits: 1, score10: 9.4, status: "Đạt" },
        { code: "2LAN2101", name: "ENGLISH SKILLS 1", credits: 1, score10: 9.6, status: "Đạt" },
        { code: "CTS12125", name: "KIẾN TRÚC MÁY TÍNH", credits: 2, score10: 9.6, status: "Đạt" },
        { code: "CTS12126", name: "CƠ SỞ DỮ LIỆU", credits: 3, score10: 9.6, status: "Đạt" },
        { code: "CTS12127", name: "LẬP TRÌNH CƠ BẢN", credits: 3, score10: 9.6, status: "Đạt" },
        { code: "CTS13125", name: "CẤU TRÚC DỮ LIỆU VÀ GIẢI THUẬT", credits: 3, score10: 10.0, status: "Đạt" },
        { code: "CTS13126", name: "MẠNG MÁY TÍNH", credits: 3, score10: 10.0, status: "Đạt" },
        { code: "CTS13127", name: "CƠ SỞ LẬP TRÌNH", credits: 4, score10: 9.8, status: "Đạt" }
      ]
    },
    {
      id: "hk2-2023-2024",
      ...
      courses: [
        { code: "2ENG21321", name: "SPEAKING 2", credits: 1, score10: 9.4, status: "Đạt" },
        { code: "2ENG21322", name: "LISTENING 2", credits: 1, score10: 8.2, status: "Đạt" },
        { code: "2ENG21323", name: "READING 2 & WRITING 2", credits: 2, score10: 10.0, status: "Đạt" },
        { code: "2LAN22202", name: "ENGLISH SKILLS 2", credits: 4, score10: 9.5, status: "Đạt" },
        { code: "2SOC11497", name: "ĐẠI SỐ TUYẾN TÍNH", credits: 3, score10: 9.0, status: "Đạt" },
        { code: "CTS22127", name: "HỆ ĐIỀU HÀNH", credits: 2, score10: 9.6, status: "Đạt" },
        { code: "CTS23130", name: "PHÂN TÍCH, TRỰC QUAN DỮ LIỆU VỚI PYTHON", credits: 3, score10: 9.6, status: "Đạt" },
        { code: "CTS24128", name: "CẤU TRÚC DỮ LIỆU VÀ GIẢI THUẬT", credits: 4, score10: 9.0, status: "Đạt" },
    ...
    },
    {
      ...
      courses: [
        { code: "2ENG21325", name: "SPEAKING 3", credits: 1, score10: 9.4, status: "Đạt" },
        { code: "2ENG21326", name: "LISTENING 3", credits: 1, score10: 9.2, status: "Đạt" },
        { code: "2ENG21327", name: "READING 3 & WRITING 3", credits: 2, score10: 8.6, status: "Đạt" },
        { code: "2GEN0001", name: "GIÁO DỤC QUỐC PHÒNG", credits: 11, score10: 0, status: "Không đạt" },
        { code: "2GEN0008", name: "PHÁP LUẬT ĐẠI CƯƠNG", credits: 2, score10: 9.5, status: "Đạt" },
        { code: "2GEN0011", name: "TRIẾT HỌC MÁC - LÊNIN", credits: 3, score10: 10.0, status: "Đạt" },
        { code: "2GEN002SWI", name: "BƠI LỘI", credits: 1, score10: 10.0, status: "Đạt" },
        { code: "2LAN22303", name: "ENGLISH SKILLS 3", credits: 4, score10: 9.0, status: "Đạt" }
      ]
    },
    {
      id: "hk1-2025-2026",
      ...
      courses: [
        ...
        { code: "CTS53151", name: "PHÁT TRIỂN VẬN HÀNH VÀ BẢO TRÌ PHẦN MỀM", credits: 3, score10: null, status: "Đang học" },
  ...
  const calculateSemesterStats = (courses: any[]) => {
    ...
    return {
      ...
      totalCredits,
      classification: getClassification(semesterGPA4)
    };
  };
  ...
  const calculateCumulativeGPA = () => {
    const allCompletedCourses = semesterData.flatMap(sem => 
      sem.courses.filter(c => c.status === "Đạt")
    );
    ...
    return {
      ...
      totalCredits,
      maxCredits: 120,
      completedCourses: allCompletedCourses.length,
  ...
  // Chi tiết điểm của môn học - Tất cả các môn
  const courseDetails: Record<string, {
    ...
    "2BUS21440": {
      ...
      components: [
        ...
        { stt: 2, name: "Kiểm tra", weight: 30, score: 9.0 },
    ...
    "CTS13125": {
      ...
      components: [
        { stt: 1, name: "Chuyên cần và Thái độ HT", weight: 20, score: 10.0 },
        { stt: 2, name: "Kiểm tra", weight: 30, score: 9.8 },
        { stt: 3, name: "Điểm thi", weight: 50, score: 10.0 }
      ]
    },
    "CTS13126": {
      name: "MẠNG MÁY TÍNH",
    ...
    "CTS13127": {
      ...
      components: [
        { stt: 1, name: "Chuyên cần và Thái độ HT", weight: 20, score: 9.8 },
        { stt: 2, name: "Kiểm tra", weight: 30, score: 9.6 },
        { stt: 3, name: "Điểm thi", weight: 50, score: 9.8 }
      ]
    },
    // HK2 2023-2024
    "2ENG21321": {
    ...
    "2SOC11497": {
      ...
      components: [
        { stt: 1, name: "Chuyên cần và Thái độ HT", weight: 20, score: 9.0 },
        { stt: 2, name: "Kiểm tra", weight: 30, score: 8.8 },
        { stt: 3, name: "Điểm thi", weight: 50, score: 9.0 }
      ]
    },
    "CTS22127": {
      name: "HỆ ĐIỀU HÀNH",
    ...
    "2ENG21327": {
      ...
      components: [
        { stt: 1, name: "Chuyên cần và Thái độ HT", weight: 20, score: 8.6 },
        { stt: 2, name: "Kiểm tra", weight: 30, score: 8.4 },
        { stt: 3, name: "Điểm thi", weight: 50, score: 8.6 }
      ]
    },
    "2GEN0001": {
  ...
  const getClassificationColor = (classification: string) => {
    switch (classification) {
      case "Giỏi": return "bg-purple-100 text-purple-700 border-purple-200";
      case "Khá": return "bg-blue-100 text-blue-700 border-blue-200";
      case "Trung Bình": return "bg-yellow-100 text-yellow-700 border-yellow-200";
      case "Yếu": return "bg-red-100 text-red-700 border-red-200";
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200">
                <CardContent className="p-6">
                  ...
                  <Badge className={`${getClassificationColor(scoreOverview.classification)} text-base font-bold px-4 py-2 mb-3`}>
                            ...
                            return (
                              <tr key={idx} className="border-b border-gray-200 hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td className="py-3 px-3 text-center">
                                  ...
                                  >
                                    <List className={`h-4 w-4 ${course.status === "Đang học" || !courseDetails[course.code] ? 'text-gray-300' : 'text-blue-600'}`} />
                                  </Button>
                                </td>
                              </tr>
                            );
                    ...
                    <div className="mt-0 p-6 bg-gray-50 border-t border-gray-200">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                        ...
                        <div className="bg-white p-4 rounded-lg border border-gray-200">
                          ...
                          <Badge className={`${getClassificationColor(stats.classification)} text-base font-bold mt-1`}>
